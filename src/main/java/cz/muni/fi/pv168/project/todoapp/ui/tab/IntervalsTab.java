...
public class IntervalsTab extends GeneralTab {
    private final Action add = new AddInterval(tabHolder);
    private final Action edit = new EditInterval(tabHolder);
    private final Action delete = new DeleteInterval(tabHolder);
